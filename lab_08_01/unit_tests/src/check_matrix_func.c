...
int check_matrixes(int **matrix_a, int **matrix_b, int size)
{
    int result = YES;
...
START_TEST(ME_test)
{
    ...
    int **matrix_res = alloc_matrix(4, 4);
    matrix_res[0][0] = 2;
    matrix_res[0][1] = 5;
    matrix_res[0][2] = 2;
    matrix_res[0][3] = 2;
...
START_TEST(MM_test)
{
    int **matrix_a = alloc_matrix(2, 2);
    matrix_a[0][0] = 2;
    matrix_a[0][1] = 3;
    matrix_a[1][0] = 4;
    matrix_a[1][1] = 5;
    
    int **matrix_b = alloc_matrix(2, 2);
    matrix_b[0][0] = 5;
    matrix_b[0][1] = 3;
    matrix_b[1][0] = 4;
    matrix_b[1][1] = 2;
